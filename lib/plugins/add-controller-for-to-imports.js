...
module.exports = function addControllerForToImports({ nodePath, imports, utils, projectNameSpace, fileName }) {
  ...
  controllerForPaths.forEach((currentPath) => {
    ...
    if (args && args.type === 'Literal') {
      ...
      let controllerFile = utils.resolveFilePath(`${projectNameSpace}/controllers/${controllerPath}`);
