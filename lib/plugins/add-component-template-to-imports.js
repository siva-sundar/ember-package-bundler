...
module.exports = function addComponentTemplateToImports({ imports, nodePath, fileName, allFiles, projectNameSpace, utils }) {
  ...
  if (layoutNameProperty.length) {
    ...
    let templateFile = utils.resolveFilePath(`${projectNameSpace}/templates/components/${templatePath}`);
    ...
    let templateFile = utils.resolveFilePath(templatePath);
