...
module.exports = function addInjectControllerToImports({ nodePath, imports, projectNameSpace, fileName, utils }) {
  ...
  if (injectControllerProperty.length) {
    ...
    let controllerFile = utils.resolveFilePath(`${projectNameSpace}/controllers/${name}`);
